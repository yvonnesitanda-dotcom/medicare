...
const Addproducts = () => {
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      formData.append("product_description", description); // 🔥 FIXED KEY
      formData.append("product_cost", productcost);
      formData.append("product_photo", productphoto);

      const response = await axios.post(
        "https://yvonnesitanda.alwaysdata.net/api/add_product",
        formData
      );
  ...
  return (
    <div className='addproduct-page row justify-content-center'>
      <div className='col-md-6 card addproduct-card p-4'>
        ...
        {loading && <p className='text-info'>Uploading...</p>}
        ...
        <form onSubmit={handlesubmit}>
          ...
          <input
            ...
            required
            accept='image/*'
            onChange={(e) => setProductphoto(e.target.files[0])}  // ✅ FIXED
          />
